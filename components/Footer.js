      ...
      <footer className="p-6 sm:p-10">
        <div className="md:flex md:justify-between">
          <div className="flex flex-col justify-between gap-4 mb-6 md:mb-0">
            <div className="text-2xl font-bold uppercase cursor-pointer text-background">
              encrease
            </div>
            <div className="md:w-[95%] lg:w-[80%] xl:w-[60%] text-xs text-gray-400">
              Supporting information system for this entrepreneurial pioneering
              school is a web-based application, that provides goods or services
              provided by students or school residents.
            </div>
          </div>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-xs text-gray-400 sm:text-center">
            ...
            <a href="https://Encrease.com/" className="ml-1 hover:underline">
              Encrease
            </a>
            .
          </span>
          <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            <Link
              ...
              target="_blank"
            >
              <div className="text-gray-500 hover:text-background">
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
                  viewBox="0 0 24 24"
